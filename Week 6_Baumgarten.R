# Assignment 6_Baumgarten

# Question 1

path.name <- '/Users/corybaumgarten/Documents/Northwestern/2017SU_PREDICT_410-DL_SEC55/Data/';
my.data <- read.csv(paste(path.name,'stock_portfolio.csv',sep=''),header=TRUE); 
head(my.data)
str(my.data)
...
# If you need to install corrplot package;
# Note how many dependencies this package has; 
...
text(pc.1,pc.2,labels=names(pc.1),cex=0.5)
